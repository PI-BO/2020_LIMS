...
<div class="analyse_erstellen_entry">
    <input type="number" min="0" step="0.001" name=<%=AnalyseErstellenServlet.AUSWAAGE_MG%>>
</div>
...
<div class="analyse_erstellen_entry">
    <input type="text" name=<%=AnalyseErstellenServlet.TIEGEL%>>
</div>

<div class="analyse_erstellen_header">Tiegelpräsentation</div>
<div class="analyse_erstellen_entry">
    <input type="text" name=<%=AnalyseErstellenServlet.TIEGELPRAESENTATION%>>
</div>
...
<table style="display: none">
    <tr class="temperaturprogramm_tamplate_table_row">
        ...
        <td class="eingangsanalyse_entry">
            <input type="number" name=<%=AnalyseErstellenServlet.TEMPERATURPROGRAMM_TEMPERATUR%>>
        </td>
