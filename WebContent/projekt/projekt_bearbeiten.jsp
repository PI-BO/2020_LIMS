	...
	<form id="form_projekt_bearbeiten">
		<table id="create_projekt_table">
			...
			<tr>
				<td>Projekt ID</td>
				<td>
					<input disabled required id="projekt_id_input_field" class="drop_down_field" type=text placeholder="Projekt auswaehlen!" name=<%=Projekt.COLUMN_PRIMARY_KEY%>>
				</td>
			</tr>
			<tr>
				<td>Projektpartner ID</td>
				<td>
					<input disabled required id="partner_id_input_field" class="drop_down_field" type=text placeholder="*" name=<%=Projekt.COLUMN_PROJEKTPARTNER%>>
				</td>
			</tr>
			<tr>
