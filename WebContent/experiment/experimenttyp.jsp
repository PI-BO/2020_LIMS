...
<div class="experiment_erstellen_header">Probe</div>
<div class="experiment_erstellen_entry">
	<input disabled type="text" name="proben_id_feedback">
</div>
...
<div class="experiment_erstellen_entry">
	<select required name=<%=ExperimentServlet.PLANUNG_ERFOLGT_DURCH%>>
		<option value="" selected required>bitte auswaehlen</option>
		<%
            try {
...
<div class="experiment_erstellen_entry">
	<select id="durchfuehrung_select" onchange="newExperimentDurchfuehrungstext(this)" required name=<%=ExperimentServlet.DURCHFUEHRUNGSTEXT%>>
		<option value="" selected disabled>bitte auswaehlen</option>
	...
	<table>
		<tr>
			<th>
				<input id="experiment_durchfuehrungstext_titel" style="display: none" type="text" placeholder="neuer Titel" name=<%=ExperimentServlet.DURCHFUEHRUNGSTEXT_TITEL%>>
			</th>
		</tr>
		<tr>
			<th>
				<textarea required id="experiment_durchführungstext_text" rows="4" cols="50" name=<%=ExperimentServlet.DURCHFUEHRUNGSTEXT_TEXT%>></textarea>
			</th>
		</tr>
	</table>
</div>
...
<div class="experiment_erstellen_entry">
	<input type="checkbox" value="true" name=<%=ExperimentServlet.PLANUNG_ABGESCHLOSSEN%>>
</div>
...
--%>
	...
	<input disabled required type="text" name=<%=ExperimentServlet.API_STARTMATERIAL%>>
</div>
...
<div class="experiment_erstellen_header typ_Slurry">Beobachtungen zur Slurryerstellung oder Abänderung des Experiments</div>
...
<div class="experiment_erstellen_header typ_Verdampfung">Beobachtungen zum Loesungsvorgang oder Abänderung des Experiments</div>
<div class="experiment_erstellen_entry typ_Verdampfung">
...
<div class="experiment_erstellen_entry">
	<input type="text" name=<%=ExperimentServlet.PRIORITAET_ANALYTIK%>>
</div>

<div class="experiment_erstellen_header">Erstanalystik PXRD</div>
<div class="experiment_erstellen_entry">
	<input type="text" name=<%=ExperimentServlet.ERSTANALYTIK_PXRD%>>
</div>

<div class="experiment_erstellen_header">PXRD möglich?</div>
<div class="experiment_erstellen_entry">
	<input type="checkbox" value="true" name=<%=ExperimentServlet.PXRD_MOEGLICH%>>
</div>

<div class="experiment_erstellen_header">Mit Ausbeute-Rest weitere Analytik möglich?</div>
<div class="experiment_erstellen_entry">
	<input type="text" name=<%=ExperimentServlet.AUSBEUTE_REST_WEITERE_ANALYTIK_MOEGLICH%>>
</div>
...
<div class="experiment_erstellen_entry">
	<input type="checkbox" value="true" name=<%=ExperimentServlet.FOLGEANALYTIK_DSC%>>
</div>

<div class="experiment_erstellen_header">Folgeanalytik TG</div>
<div class="experiment_erstellen_entry">
	<input type="checkbox" value="true" name=<%=ExperimentServlet.FOLGEANALYTIK_TG%>>
</div>

<div class="experiment_erstellen_header">Folgeanalytik PXRD II</div>
<div class="experiment_erstellen_entry">
	<input type="checkbox" value="true" name=<%=ExperimentServlet.FOLGEANALYTIK_PXRD_II%>>
</div>

<div class="experiment_erstellen_header">Folgeanalytik H-NMR</div>
<div class="experiment_erstellen_entry">
	<input type="checkbox" value="true" name=<%=ExperimentServlet.FOLGEANALYTIK_H_NMR%>>
</div>

<div class="experiment_erstellen_header">Folgeanalytik IR</div>
<div class="experiment_erstellen_entry">
	<input type="checkbox" value="true" name=<%=ExperimentServlet.FOLGEANALYTIK_IR%>>
</div>

<div class="experiment_erstellen_header">Folgeanalytik Raman</div>
<div class="experiment_erstellen_entry">
	<input type="checkbox" value="true" name=<%=ExperimentServlet.FOLGEANALYTIK_RAMAN%>>
</div>

<div class="experiment_erstellen_header">Folgeanalytik OMI</div>
<div class="experiment_erstellen_entry">
	<input type="checkbox" value="true" name=<%=ExperimentServlet.FOLGEANALYTIK_OMI%>>
</div>

<div class="experiment_erstellen_header">Informationen zur Folgeanalytik (ToDo / Parameter)</div>
<div class="experiment_erstellen_entry">
	<input type="text" name=<%=ExperimentServlet.INFORMATIONEN_FOLGEANALYTIK%>>
</div>
...
<div class="experiment_erstellen_entry">
	<input type="text" name=<%=ExperimentServlet.STATUS_ANALYTIK%>>
</div>
