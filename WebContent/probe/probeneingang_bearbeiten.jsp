...
<body>
	<form id="form_probeneingang_bearbeiten">
		<table id="table_probeneingang">
			...
			<tr class="table_probeneingang_bearbeiten_tr">
				<td>
					<input disabled required type="text" id="proben_id_input_field" placeholder="" style="color: red;" name=<%=Probeneingang.PROBEN_ID%>>
				</td>
			</tr>
	...
	<script>
        ...
        function initFormHandler() {
            ...
            form.addEventListener('submit', function (e) {
                ...
                let url = '<%=Address.MAIN_PATH + Address.ANALYSE_BEARBEITEN_SERVLET%>';
        ...
        document.getElementById('proben_id_input_field').addEventListener('change', function (e) {
            $.ajax({
                url: '<%=Address.MAIN_PATH + Address.PROBENEINGANG_BEARBEITEN_SERVLET%>',
                type: 'get',
