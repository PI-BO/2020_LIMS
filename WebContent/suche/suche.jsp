...
<body>
	...
	<div id="global_search_main_container">
		...
		<table id="global_search_parameter_table">
			<tr>
				<th>
					<input type="button" value="suchen" id="global_search_button">
				</th>
				<th>
					<input type="button" value="Filter hinzufuegen" id="global_search_add_parameter_button">
				</th>
				<th></th>
		...
		<div id="global_search_parameter_row_template" style="display: none;">
			<select class="global_search_select_main_category"></select> <select class="global_search_select_parameter"></select> <select class="global_search_select_parameter_filter"></select>
