...
public class DummyResultSet implements ResultSet{
	...
	private int resultSetEntryIndex = START_INDEX;
	...
	public String getString(int columnIndex) throws SQLException {
		...
		DummyResultSetEntry entry = resultSetEntryList.get(resultSetEntryIndex);
	...
	public boolean next() throws SQLException {
		...
		if(resultSetEntryIndex < resultSetEntryList.size()) return true;
	...
	public boolean isAfterLast() throws SQLException {
		...
		return (resultSetEntryIndex >= resultSetEntryList.size());
	}
	...
	public boolean isLast() throws SQLException {
		...
		return (resultSetEntryIndex == resultSetEntryList.size() - 1);
	}
