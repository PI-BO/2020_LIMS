...
public class ExperimenttypVerdampfung extends Model {
	...
	public void setAttributes(ResultSet resultSet) throws SQLException, ModelNotFoundException {
		if (resultSet.next()) {
			...
			beobachtungen_zum_loesungsvorgang_oder_aenderungen_des_Experiments = resultSet
					.getString(COLUMN_BEOBACHTUNGEN_ZUM_LOESEVORGANG_ODER_AENDERUNGEN_DES_EXPERIMENTS_KEY);
	...
	public DummyResultSet returnAsDummyResultSet() {
		...
		entry.addKeyValuePair(COLUMN_BEOBACHTUNGEN_ZUM_LOESEVORGANG_ODER_AENDERUNGEN_DES_EXPERIMENTS_KEY,
				beobachtungen_zum_loesungsvorgang_oder_aenderungen_des_Experiments);
