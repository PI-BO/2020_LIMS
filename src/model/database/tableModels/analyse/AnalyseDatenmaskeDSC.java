...
public class AnalyseDatenmaskeDSC extends AnalyseDatenmaskeDscTgaConst {
    ...
    public DummyResultSet returnAsDummyResultSet() {
        ...
        try {
            ...
            dummyResultSetEntry.addKeyValuePair(COLUMN_AUSWAAGE, null);
        }
        try {
    ...
    public JSON toJSON() {
        ...
        json.addKeyValue(COLUMN_AUSWAAGE, auswaage.toString());
        json.addKeyValue(COLUMN_RAMPE, rampe.toString());
        json.addKeyValue(COLUMN_TEMPERATURPROGRAMM, temperaturprgramm);
        json.addKeyValue(COLUMN_TIEGEL, tiegel);
        json.addKeyValue(COLUMN_TIEGELPRAEPARATION, tiegelpaeparation);
